...
namespace Hedgehog
{
	namespace Wrappers
	{
		bool WindowManager::IsCursorPositionInGUI = false;
		...
		void WindowManager::SetCursorUnderGUI(bool val)
		{
			IsCursorPositionInGUI = val;
		}
