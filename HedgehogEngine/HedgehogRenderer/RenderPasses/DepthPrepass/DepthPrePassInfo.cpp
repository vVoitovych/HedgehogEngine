...
namespace Renderer
{
	DepthPrePassInfo::DepthPrePassInfo(VkFormat depthFormat)
	{
		...
		m_Dependency.srcStageMask = VK_PIPELINE_STAGE_FRAGMENT_SHADER_BIT;
		m_Dependency.srcAccessMask = 0;
		m_Dependency.dstStageMask = VK_PIPELINE_STAGE_EARLY_FRAGMENT_TESTS_BIT;
