...
#include "GuiElements/Inspector.hpp"
#include "GuiElements/SceneVisualization.hpp"
#include "GuiElements/MainMenu.hpp"
#include "GuiElements/MaterialEditor.hpp"
...
namespace Renderer
{
	...
	void GuiPass::DrawGui(Context::Context& context)
	{
		...
		SceneVisualization::Draw(context);
		MainMenu::Draw(context);
		MaterialEditor::Draw(context);
		// TODO remove
