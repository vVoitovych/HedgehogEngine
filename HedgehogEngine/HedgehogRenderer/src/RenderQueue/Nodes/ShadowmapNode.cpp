...
namespace Renderer
{
    ...
    void ShadowmapNode::UpdateFrameBuffer(RHI::IRHIDevice& device, const ResourceManager& rm)
    {
        ...
        m_ShadowmapSize = shadowMap.GetWidth();
    }

    void ShadowmapNode::UpdateViewports(const HedgehogSettings::Settings& settings)
    {
    ...
    void ShadowmapNode::UpdateShadowmapMatrices(const HedgehogEngine::CameraData& camera,
                                                 const HedgehogSettings::Settings& settings,
